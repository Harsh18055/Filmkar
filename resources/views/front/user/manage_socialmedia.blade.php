...
<form action="{{route('user.manage_socialmedia_process')}}" method="post" enctype="multipart/form-data">
   ...
   <div class="profile_detail_block width">
    <input type="hidden" name="social_id" value="{{$social_id}}">
      ...
      <input type="url" name="facebook" value="{{$social->facebook ?? ''}}" class="form-control" multiple id="gallery-photo-add">
      <label>Instagram</label>
      <input type="url" name="instagram" value="{{$social->instagram ?? ''}}" class="form-control" multiple id="gallery-photo-add">
      <label>Linkedin</label>
      <input type="url" name="linkedin" value="{{$social->linkedin ?? ''}}" class="form-control" multiple id="gallery-photo-add">
      <label>Twitter</label>
      <input type="url" name="twitter" value="{{$social->twitter ?? ''}}" class="form-control" multiple id="gallery-photo-add">
